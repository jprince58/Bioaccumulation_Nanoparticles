...
xi=np.array([10]) #Define dimensionless and porosity adjusted maximum binding site density
K=np.array([0.01]) #Define dimensionless and porosity adjusted equilibrium constant
a=np.array([7]) #Define shape paramter for binding site profile
