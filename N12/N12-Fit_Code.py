...
params.add('mu', value=1, min=0., max=10.)
# params.add('mu', value=0.01, vary=False)
# params.add('nu', value=10, min=0.01, max=100.)
params.add('nu', value=0, vary=False)
params.add('phi_min', value=0.3, min=0.1, max=0.5)
# params.add('phi_min', value=0.25, vary=False)
params.add('phi_max', value=0.8, min=0.5, max=1)
# params.add('phi_max', value=0.8, vary=False)
# params.add('kappa', value=1, min=0.1, max=50.)
...
params.add('b', value=15, vary=False)
